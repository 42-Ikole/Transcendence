<template>
  <div>
    ...
    <div v-if="twoFactorEnabled">
      <button class="btn btn-outline-danger btn-lg" @click="disableTwoFactor">
        Disable
      </button>
    </div>
    <div v-else>
      <div v-if="isPending">
        ...
        <div v-if="errorHappened" class="text-warning">invalid code</div>
      </div>
      <div v-else>
        <button
          class="btn btn-outline-success btn-lg ms-1"
