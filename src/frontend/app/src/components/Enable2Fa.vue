...
async function readCompleteStream(body: ReadableStream<Uint8Array>): Promise<Uint8Array> {
...
export default defineComponent({
	...
	methods: {
		async register() {
			...
			this.qrcode = URL.createObjectURL(new Blob([content.buffer], { type: 'image/png '}));
